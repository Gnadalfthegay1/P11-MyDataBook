...
public class VaccinationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvVax = v.findViewById(R.id.tvVax);
        btPop = v.findViewById(R.id.btPop2);
        SharedPreferences sharedPref = getActivity().getPreferences(Context.MODE_PRIVATE);
        String thing = sharedPref.getString("edit", "");
        tvVax.setText(thing);
        et1 = v.findViewById(R.id.etEdit1);
        btPop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SharedPreferences sharedPref = getActivity().getPreferences(Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPref.edit();
                editor.putString("edit", et1.getText().toString());
                editor.commit();
                String thing = sharedPref.getString("edit", "");
                tvVax.setText(thing);
            }
